...
/**
 * This test checks that 'Fireball' is working correctly.
 */
public class FireballTest {
	...
	public void testPlayFireball() {
		final Player player1 = new Player()
			.setHitPoints(30)
			.setAvailableMana(4)
			.addToHand(CardRepository.createByName("Fireball"));
		...
		Assert.assertEquals("player two, current hit points", 24, afterState.getPlayer(PlayerOrdinal.Two).getCurrentHitPoints());
	}
}
